...
class Kkofrkofrokrogt(gtjgtjgtigt: Application): ViewModel() {
    val gtgtjtgjgti = gtjgtjgtigt.packageManager
    fun hyy59ju95uj(ju26ju2uj26: WebView): WebSettings{
       val rfgtjoj = ju26ju2uj26.settings
    ...
    fun ju59uj59uj95(gthgtiuhgtugt: String) {
